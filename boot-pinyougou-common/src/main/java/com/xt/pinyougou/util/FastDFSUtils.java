...
public class FastDFSUtils {
     ...
     * @throws IOException
     */
    public String uploadFile(MultipartFile file, String fileServerUrl) throws IOException {
        ...
        String url = fileServerUrl + storePath.getFullPath();
     ...
     * @return
     */
    public void delete(String path, String fileServerUrl) {
